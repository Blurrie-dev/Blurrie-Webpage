...
The ✨ *AMA* app is a chat window backed by Claude Haiku 4.5 through a tiny
Cloudflare Worker in `worker/` (the API key never touches the browser). It
...
worker/           Cloudflare Worker behind the AMA app
